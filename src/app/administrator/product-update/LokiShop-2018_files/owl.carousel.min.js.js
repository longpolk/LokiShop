...
!(function(a, b, c, d) {
  ...
  (e.Defaults = {
    ...
    c
      ...
      : (e = a.extend({}, this.options)), (null !== this.settings &&
      this._breakpoint === d) ||
      (
    ...
    this.$stage.empty(), (this._items = []), b &&
      ...
      .each(
        a.proxy(function(a, b) {
          (b = this.prepare(
            b
          )), this.$stage.append(b), this._items.push(b), this._mergers.push(1 * b.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") || 1);
        }, this)
      ), this.reset(
      ...
      : void ("youtube" === c.type
          ...
          : "vimeo" === c.type
            ...
            : "vzaar" === c.type &&
              a.ajax({
                type: "GET",
                url: "http://vzaar.com/api/videos/" + c.id + ".json",
                jsonp: "callback",
                dataType: "jsonp",
                success: function(a) {
          ...
          : "vimeo" === f.type
            ...
            : "vzaar" === f.type &&
              (c =
                ...
                '"width="' +
                g +
                '" allowfullscreen mozallowfullscreen webkitAllowFullScreen src="http://view.vzaar.com/' +
                f.id +
