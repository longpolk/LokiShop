...
!(function(a, b) {
    ...
    function(a, b) {
      n.fn[a] = function(c, d) {
        ...
        return "Until" !== a.slice(-5) && (d = c), d &&
          ...
          (E[a] || n.uniqueSort(e), D.test(a) && e.reverse()), this.pushStack(
          e
        );
      };
    }
  ...
  ($.optgroup =
    $.option), ($.tbody = $.tfoot = $.colgroup = $.caption = $.thead), ($.th = $.td);
  function _(a, b) {
    var c =
      ...
      if (((f = a[o]), f || 0 === f))
        if ("object" === n.type(f)) n.merge(m, f.nodeType ? [f] : f);
          ...
          (g = g || l.appendChild(b.createElement("div"))), (h = (Y.exec(f) || [
            ...
            .toLowerCase()), (i = $[h] || $._default), (g.innerHTML =
            i[1] + n.htmlPrefilter(f) + i[2]), (k = i[0]);
  ...
  !(function() {
    ...
    c.setAttribute(
      "type",
      "radio"
    ), c.setAttribute("checked", "checked"), c.setAttribute("name", "t"), b.appendChild(c), (l.checkClone = b.cloneNode(!0).cloneNode(!0).lastChild.checked), (b.innerHTML = "<textarea>x</textarea>"), (l.noCloneChecked = !!b.cloneNode(!0).lastChild.defaultValue);
  })();
  var da = /^key/,
  ...
  (n.event = {
    ...
    fix: function(a) {
      ...
      h ||
        (this.fixHooks[f] = h = ea.test(f)
          ? this.mouseHooks
          : da.test(f) ? this.keyHooks : {}), (e = h.props
    ...
    off: function(a, b, c) {
      ...
      return (b !== !1 && "function" != typeof b) ||
        ((c = b), (b = void 0)), c === !1 && (c = ha), this.each(function() {
  ...
  function ua(a, b, c, d) {
    ...
    if (
      ...
      for (h = n.map(_(e, "script"), qa), i = h.length; o > m; m++)
        (j = e), m !== p &&
          ((j = n.clone(j, !0, !0)), i && n.merge(h, _(j, "script"))), c.call(
          a[m],
          j,
          m
        );
  ...
  n.extend({
    ...
    clone: function(a, b, c) {
      ...
      return (g = _(h, "script")), g.length > 0 &&
        aa(g, !i && _(a, "script")), h;
    },
    ...
    function(a, b) {
      n.fn[a] = function(a) {
        for (var c, d = [], e = n(a), f = e.length - 1, h = 0; f >= h; h++)
          (c = h === f ? this : this.clone(!0)), n(e[h])[b](c), g.apply(
            d,
            c.get()
          );
  ...
  function za(a) {
    ...
    return c ||
      (
        ...
        ("none" !== c && c) ||
          (
            (wa = (wa || n("<iframe frameborder='0' width='0' height='0'/>"))
  ...
  !(function() {
    ...
    if (h.style) {
      ...
      function i() {
        ...
        (b = "1%" !== d.top), (f = "2px" === d.marginLeft), (c =
          "4px" === d.width), (h.style.marginRight = "50%"), (e =
      ...
      n.extend(l, {
        ...
        reliableMarginRight: function() {
          ...
          return (c.style.cssText = h.style.cssText =
            "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0"), (c.style.marginRight = c.style.width =
            "0"), (h.style.width = "1px"), Ea.appendChild(g), (b = !parseFloat(
            a.getComputedStyle(c).marginRight
  ...
  function Fa(a, b, c) {
    ...
    return (c =
      ...
      Ca(
        a
      )), (g = c ? c.getPropertyValue(b) || c[b] : void 0), ("" !== g && void 0 !== g) || n.contains(a.ownerDocument, a) || (g = n.style(a, b)), c && !l.pixelMarginRight() && Ba.test(g) && Aa.test(b) && ((d = h.width), (e = h.minWidth), (f = h.maxWidth), (h.minWidth = h.maxWidth = h.width = g), (g = c.width), (h.width = d), (h.minWidth = e), (h.maxWidth = f)), void 0 !== g ? g + "" : g;
  }
  function Ga(a, b) {
    return {
      get: function() {
  ...
  function Za(a, b, c) {
    ...
    if (n.isEmptyObject(m))
      ...
      q
        ...
        : (q = N.access(a, "fxshow", {})), f && (q.hidden = !p), p
        ? n(a).show()
        : l.done(function() {
            n(a).hide();
          }), l.done(function() {
  ...
  (n.Animation = n.extend(_a, {
    ...
    tweener: function(a, b) {
      ...
      for (var c, d = 0, e = a.length; e > d; d++)
        (c = a[d]), (_a.tweeners[c] = _a.tweeners[c] || []), _a.tweeners[
          c
        ].unshift(b);
    },
    prefilters: [Za],
    ...
    (a.type =
      "checkbox"), (l.checkOn = "" !== a.value), (l.optSelected = c.selected), (b.disabled = !0), (l.optDisabled = !c.disabled), (a = d.createElement("input")), (a.value = "t"), (a.type = "radio"), (l.radioValue = "t" === a.value);
  })();
  var ab,
    ...
    valHooks: {
      ...
      select: {
        ...
        set: function(a, b) {
          ...
          while (g--)
            (d = e[g]), (d.selected =
              n.inArray(n.valHooks.option.get(d), f) > -1) && (c = !0);
      ...
      if (
        ...
        while ((h = p[g++]) && !b.isPropagationStopped())
          (b.type = g > 1 ? j : o.bindType || q), (m =
            (N.get(h, "events") || {})[b.type] && N.get(h, "handle")), m &&
            m.apply(h, c), (m = l && h[l]), m &&
            m.apply &&
            L(h) &&
  ...
  }), (l.focusin = "onfocusin" in a), l.focusin ||
  ...
  n.extend({
    ...
    ajax: function(b, c) {
      ...
      if (
        ...
        return x;
      (k = n.event && m.global), k &&
        0 === n.active++ &&
        n.event.trigger(
          "ajaxStart"
        ), (m.type = m.type.toUpperCase()), (m.hasContent = !qb.test(
        m.type
      )), (f = m.url), m.hasContent ||
        (
          m.data &&
  ...
  (l.cors =
    !!Ib &&
    "withCredentials" in Ib), (l.ajax = Ib = !!Ib), n.ajaxTransport(function(
    b
  ) {
    var c, d;
      ...
      ? (
          ...
          d.always(function() {
            void 0 === f
              ...
              : (a[
                  e
                ] = f), b[e] && ((b.jsonpCallback = c.jsonpCallback), Jb.push(e)), g && n.isFunction(f) && f(g[0]), (g = f = void 0);
          }),
          "script"
        )
      : void 0;
